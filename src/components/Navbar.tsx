...
// import { BookOpen, FileText } from 'lucide-react'; // For future use
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-primary-500 font-mono text-sm">~harini</span>
            </div>
              ...
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={
                      isActive(item.path)
                        ? 'flex items-center justify-between px-3 py-3 rounded-md text-base font-medium text-primary-500 bg-bg-surface border-l-2 border-primary-500'
                        : 'flex items-center justify-between px-3 py-3 rounded-md text-base font-medium text-neutral-200 hover:text-primary-500 hover:bg-bg-surface'
                    }
                  >
                    ...
                    <ChevronRight
                      size={16}
                      className={isActive(item.path) ? 'text-primary-500' : ''}
                    />
                  </Link>
                );
              })}
