  ...
  const timeline = [
    {
      ...
      description:
        'Working on cloud automation, CI/CD pipelines, Monitoring and container orchestration using AWS, Docker, Grafana and Linux/Shell scripting.',
      icon: Code,},
    {
              ...
              <div className="bg-bg-elevated border border-neutral-700 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-primary-500 font-mono">6</span>
                  </div>
                  <div className="flex items-center justify-between">
